...
public class SplitScreenRenderFeature : ScriptableRendererFeature
{
    class CustomRenderPass : ScriptableRenderPass
    {
        ...
        public CustomRenderPass() : base()
        {
            tempTextureHandle.Init("_TempBlitMaterialTexture");
        }

        public void SetSource(SplitScreenRenderer splitScreenRenderer, RenderTargetIdentifier source)
        {
            this.splitScreenRenderer = splitScreenRenderer;
            this.source = source;    
        }
    ...
    {
        if(renderingData.cameraData.camera.gameObject.tag == "MainCamera")
        {
            m_ScriptablePass.SetSource(
                renderingData.cameraData.camera.GetComponent<SplitScreenRenderer>(),
